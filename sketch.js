...
console.log(boxBottomWall.position)
...
//rect(boxLeftWall.position.x,boxLeftWall.position.y,10,100)
//rect(boxRightWall.position.x,boxRightWall.position.y,10,100)
//rect(boxBottomWall.position.x,boxBottomWall.position.y,400,655)
